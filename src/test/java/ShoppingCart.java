...
public class ShoppingCart {
	...
	public void navigateToOptimusEcart()
	{
		...
		driver.manage().timeouts().implicitlyWait(5000,TimeUnit.MILLISECONDS);
		List<WebElement> featuredItemsLink = driver.findElements(By.xpath("//ul[@class = 'grid grid--uniform grid--view-items']/li"));
		System.out.println("Featured items size "+featuredItemsLink.size());
		featuredItemsLink.get(0).click();
